...
use MVQN\UCRM\Plugins\Exceptions\RequiredDirectoryNotFoundException;
use MVQN\UCRM\Plugins\Exceptions\RequiredFileNotFoundException;
...
final class Config extends AutoObject
{
     ...
     * @throws RequiredDirectoryNotFoundException
     ...
     * @throws \MVQN\UCRM\Plugins\Exceptions\ManifestElementException
